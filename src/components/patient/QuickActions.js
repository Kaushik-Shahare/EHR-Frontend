...
export default function QuickActions({ patientId, onAddDocument, onAddPrescription, onAddLabResult, onAddNotes, hasActiveSession, onRequestSession }) {
  ...
  const handleNoteSubmit = async (e) => {
    ...
    try {
      if (onAddNotes) {
        const success = await onAddNotes(note);
        if (success) {
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <button 
                  ...
                  className="flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 rounded-lg p-3 transition-colors">
                    ...
                    <span className="text-sm font-medium">Add Lab Results</span>
                </button>
                <button 
                ...
                <div className="p-6 space-y-4">
                  <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                    <p className="text-sm text-blue-700">
                      <span className="font-medium">Upload Lab Reports, Prescriptions & Medical Documents</span>
                      <br />
                      Supported formats: PDF documents, medical images (JPG, PNG, TIFF), and DICOM files up to 10MB
                    </p>
                  </div>
                  <div>
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600">
                          <label htmlFor="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                            ...
                            <input
                              ...
                              type="file"
                              className="sr-only"
                              accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.tiff,.dicom"
                        ...
                        <p className="text-xs text-gray-400">
                          Supports medical imaging formats (TIFF, DICOM)
                        </p>
                      </div>
                    </div>
                    {documentFile && (
